...
(3, 'Appartement', 48.871099, 2.304455, 3, '../images/appartement.png', 100, 100, 17, "<center>Installation dans un appartement proche des Champs Élysées où elle fait la rencontre d'Alain Delon, son voisin de palier.<br/><b>Allez à l'Olympia ( Près de l'opéra Garnier ) pour débuter la carrière de Dalida.</b></center>"),
...
(6, 'Sanremo', 43.816546, 7.77597, 6, '../images/micro.png', 57, 155, 14, "<center>Le 26 janvier 1967, Dalida participe au festival de chanson de Sanremo avec Luigi Tenco, le nouvel homme de sa vie qu'elle a convaincu de participer à la compétition. <b>Elle retourne à l'Olympia pour enregister son prochain tube</b>.</center>"),
(7, 'Palais des sports', 48.832714, 2.287051, 7, '../images/palais_des_sports.jpg', 128, 81, 17, "<center>Après cette période, Dalida commence à se fatiguer et elle se produit une dernière fois en Turquie. Elle a ce soir rendez-vous avec François Naudy au Mogador, au sud-est de la gare de Saint-Lazare. Elle se prépare chez elle. </center>"),
(8, 'Alain Delon', NULL, NULL, NULL, '../images/alain_delon.jpg', 87, 110, NULL, NULL),
(9, 'Disque Dalida', 48.870420, 2.330827, NULL, '../images/disque_dalida.png', 80, 80, 17, "<center>Elle enregistre son premier <b>45 tours</b>, elle va ensuite faire les premières parties d'un artiste que vous trouverez à Montmartre. <br/><b>Allez le voir pour récupérer le disque<b></center>"),
...
(14,'Maison Dalida', 48.886999, 2.336988, NULL, '../images/house.png', 100, 100, 17, "<center>En réalite, dans la nuit du 2 au 3 mai 1987, restée seule dans sa maison du 11 bis rue d'Orchampt, elle se suicide par surdose de barbituriques, qu’elle avale avec du whisky.</center>"),
